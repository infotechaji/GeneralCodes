...
History    : 
                ...
                v1.1 - 05/06/2019  - Receivers type identification is added 
Pending    :
Open issues   :
"""
...
class Gmail():
    def __init__(self,sender,password,developer_mode=True):
        self.sender=sender
    ...
    def send_mail(self,input_dict,receivers):
        ...
        if type(receivers)==list:
            ...
            print 'Please follow list or string (comma separated ) for receivers '
            exit()
