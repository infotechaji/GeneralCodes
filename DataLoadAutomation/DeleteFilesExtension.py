...
if __name__=="__main__":
    ...
    if True :
        ...
        files_list=['RunBatFile_startedbasic_details.txt','DownloadBlob_startedbasic_details.txt','CreateBatFile_startedbasic_details.txt','CombineFiles_startedbasic_details.txt']
